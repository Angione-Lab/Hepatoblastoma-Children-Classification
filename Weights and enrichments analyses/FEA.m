...
% .. Modified by GIUSEPPE MAGAZZU' 07/11/2019
...
gopvalues = hygecdf(allSubsystems'-1, repmat(length(model.rxns), length(nRxns), 1), nRxns, repmat(length(rxnSet), length(nRxns), 1), 'upper');
